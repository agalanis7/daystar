...
class GeneralContracting extends Component{
    constructor () {
        super()
        this.state = {
          isOpen: false
    ...
    render(){
        return(
            <React.Fragment>
                {/* Start Pagehelmet  */}
                <PageHelmet pageTitle='General Contracting' />
                {/* End Pagehelmet  */}
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    <h2 className="title theme-gradient">General Contracting</h2>
                                    <p>Decks that stand the test of time</p>
                                </div>
                            </div>
                        </div>
                    </div>
